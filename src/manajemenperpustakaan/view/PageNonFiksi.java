...
public class PageNonFiksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableNonFiksi = new javax.swing.JTable();
        ...
        tableNonFiksi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tableNonFiksi);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PageNonFiksi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PageNonFiksi().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableNonFiksi;
